<template>
    ...
    <v-card class="rounded-0" elevation="2" height="320">
        <v-btn icon="mdi-close-circle" color="red-darken-3" title="Remove Agent" class="removeAgent pa-0" variant="text"
        ...
        <v-dialog v-model="removeDialog" width="auto">
            <v-card class="pa-8">
                ...
                <div class="my-2">
                    <v-btn class="ma-2" width="150" color="red-darken-3" @click="handleRemoveAgent" :loading="loader">Remove</v-btn>
