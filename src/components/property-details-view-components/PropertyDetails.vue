<template>
  <v-row no-gutters class="d-flex justify-space-between align-center">
    ...
    <v-col v-if="props.details?.propertyAddedDate" cols="12" class="mb-1 mt-n2">
      <v-card-item class="titleCont my-0 mx-0">
        <v-card-title
          class="px-3 text-body-2 text- font-weight-regular bg-blue-grey-lighten-1"
          style="line-height: 25px"
          >Posted On : &nbsp; {{ postedDate }}</v-card-title
        >
      </v-card-item>
    </v-col>
  </v-row>
  ...
  <v-row
    no-gutters
    class="px-4 pb-6 text-body-1 font-weight-medium text-grey-darken-2"
  >
    ...
    <v-col v-if="props.details?.type" class="pdLH" cols="12"
      >Property Type:
      <span class="text-body-1 text-grey-darken-1">
        {{ props.details?.type }}
      </span>
    </v-col>
    <v-col class="pdLH" cols="12"
      >Property:
      <span class="text-body-1 text-grey-darken-1">
        {{ props.details?.isVerifiedByCheckedSpot ? "Verified" : "Unverified" }}
      </span>
    </v-col>
    <v-col v-if="props.details?.isFreeHold" class="pdLH" cols="12"
      >Property:
      <span class="text-body-1 text-grey-darken-1">
        {{ props.details?.isFreeHold ? "Freehold" : "" }}
      </span>
    </v-col>
    <v-col v-if="props.details?.title?.length > 0" class="pdLH" cols="12"
      >Title:
      <span class="text-body-1 text-grey-darken-1">
        {{ props?.details?.title }}
      </span>
    ...
    <v-col
      v-if="props.details?.address !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Address:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col v-if="props.details?.totalArea > 0" class="pdLH" cols="12"
      >Total Area:
      <span class="text-body-1 text-grey-darken-1">
        {{ props.details?.totalArea }} sqft
      </span>
    </v-col>
    <v-col v-if="props.details?.builyupArea > 0" class="pdLH" cols="12"
      >Builtup Area:
      <span class="text-body-1 text-grey-darken-1">
        {{ props.details?.builyupArea }} sqft
      </span>
    </v-col>
    <v-col v-if="props.details?.carpetArea > 0" class="pdLH" cols="12"
      >Carpet Area:
      <span class="text-body-1 text-grey-darken-1">
        {{ props.details?.carpetArea }} sqft
      </span>
    </v-col>
    <v-col v-if="props.details?.noOfBedroom > 0" class="pdLH" cols="12"
      >Bedrooms:
      <span class="text-body-1 text-grey-darken-1">
        {{ props.details?.noOfBedroom }}
      </span>
    </v-col>
    <v-col v-if="props.details?.noOfBathroom > 0" class="pdLH" cols="12"
      >Bathrooms:
      <span class="text-body-1 text-grey-darken-1">{{
        props.details?.noOfBathroom
      }}</span>
    </v-col>
    <v-col v-if="props.details?.noOfKitchen > 0" class="pdLH" cols="12"
      >Kitchens:
      <span class="text-body-1 text-grey-darken-1">{{
    ...
    <v-col
      v-if="props.details?.balcony !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Balcony:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.diningArea !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Dining Area:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col v-if="props.details?.garden !== 'unavailable'" class="pdLH" cols="12"
      >Garden:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.parkingLot !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Parking Lot:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.elevator !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Elevator:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.furnishedStatus !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Furnished Status:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.airConditioning !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Air Conditioning:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.swimmingPool !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Swimming Pool:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.laundryRoom !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Laundry Room:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col v-if="props.details?.gym !== 'unavailable'" class="pdLH" cols="12"
      >Gym:
      <span class="text-body-1 text-grey-darken-1">
        {{ props.details?.gym }}
      </span>
    </v-col>
    <v-col v-if="props.details?.wifi !== 'unavailable'" class="pdLH" cols="12"
      >Wi Fi:
      <span class="text-body-1 text-grey-darken-1">
        {{ props.details?.wifi }}
      </span>
    ...
    <v-col
      v-if="props.details?.tvCable !== 'unavailable'"
      class="pdLH"
      cols="12"
      >TV Cable:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.dishWasher !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Dish Washer:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.refrigerator !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Refrigerator:
      <span class="text-body-1 text-grey-darken-1">
    ...
    <v-col
      v-if="props.details?.outdoorShower !== 'unavailable'"
      class="pdLH"
      cols="12"
      >Outdoor Shower:
      <span class="text-body-1 text-grey-darken-1">
