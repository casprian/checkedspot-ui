        ...
        <v-row no-gutters class="mb-2">
          <v-col cols="4" class="d-flex align-center justify-center">
            <v-avatar
              ...
              size="65"
              color="grey-darken-3"
              image="https://checkedspot.blob.core.windows.net/gallery/8a213c41-9394-4f94-9d13-8a3d08c43433.png"
            ></v-avatar>
          </v-col>
          <v-col cols="8">
      ...
      <v-card-item>
        ...
        <v-sheet>
          <v-row no-gutters class="mb-2">
            ...
            <v-col cols="8">
              <v-card-title>
                {{ agent?.name ? agent?.name : "Not Found" }}
              </v-card-title>
              <div class="my-2 d-flex justify-start align-center">
                <v-icon icon="mdi-phone" size="19" color="#FF385C"></v-icon>
                <div class="text-subtitle-1 pl-3 text-grey-darken-1">
                  {{ agent?.mobile ? agent?.mobile : "Not Found" }}
                </div>
              </div>
              <div class="my-2 d-flex justify-start align-center">
                <v-icon icon="mdi-email" size="19" color="#FF385C"></v-icon>
                <div class="text-subtitle-1 pl-3 text-grey-darken-1">
                  {{ agent?.email ? agent?.email : "Not Found" }}
                </div>
              </div>
            </v-col>
          </v-row>
