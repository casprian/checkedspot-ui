    ...
    <v-row no-gutters>
      <v-col cols="12">
        ...
        <p class="py-3 text-indigo-lighten-1 text-center text-body-1">
          Over 100 happy family members are part of Checked Spot family.
        </p>
      </v-col>
...
const customerDetails = reactive([
  {
    ...
    detail:
      "I would recommend Checked Spot to all our family and friends. Keep up the good work!",
    name: "Divyashant",
  },
  {
    img1: "https://cdn.vuetifyjs.com/images/cards/sunshine.jpg",
    detail:
      "The whole team was very supportive & I am really very happy. I am an extremely happy customer.",
    name: "Vivek",
  },
  {
    img1: "https://cdn.vuetifyjs.com/images/cards/sunshine.jpg",
    detail: "What helps truly was that Checked Spot was always there with us!",
    name: "Divyashant",
  },
  {
    img1: "https://cdn.vuetifyjs.com/images/cards/sunshine.jpg",
    detail:
      "My wife Swati and I had a fantastic house-building experience with Checked Spot",
    name: "Vivek",
  },
  {
    img1: "https://cdn.vuetifyjs.com/images/cards/sunshine.jpg",
    detail:
      "Thank you Checked Spot for all your support, it was a great journey",
    name: "Divyashant",
  },
  {
    img1: "https://cdn.vuetifyjs.com/images/cards/sunshine.jpg",
    detail: "Checked Spot helped me achieve this journey without much hassle",
    name: "Vivek",
  },
]);
</script>
