    ...
    <v-container>
        <v-row no-gutters class="my-5">
            <v-col cols="12">
                ...
                <p class="text-h5 font-weight-medium">Find better places to live, <span class="text-h4 font-weight-bold">work and wonder...</span></p>
            </v-col>
            <v-col cols="12" class="mt-10">
                <v-row no-gutters>
                    ...
                    <v-col cols="12" sm="6" class="d-flex justify-center flex-column px-0 px-sm-16">
                        ...
                        <v-btn variant="outlined" class="rounded-lg" color="deep-purple-lighten-1" max-width="165px">EXPLORE BUYING</v-btn>
