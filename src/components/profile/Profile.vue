  ...
  <v-row id="view" no-gutters class="px-10 py-10">
    <v-col cols="12" class="d-flex align-center justify-center">
      <v-card
        width="100%"
        height="200px"
        class="px-6 px-sm-10 d-flex align-center"
      >
          ...
          <v-col cols="9">
            ...
            >
              <v-col
                cols="12"
                md="6"
                class="d-flex d-md-block flex-column justify-center mb-5 mb-md-0"
              >
                <h2 class="mb-2 text-center text-md-start">
                  {{ userdata?.name ? name : "-----" }}
                </h2>
                <update-profile-picture
                  invocationMethod="button"
              ...
              <v-col
                cols="12"
                md="6"
                class="d-flex flex-column justify-center align-md-center"
              >
                <v-progress-linear
    ...
    <v-col cols="12" class="px-2 pt-3 myProfileDetails">
      <div class="myProfileDetails d-flex justify-space-between align-center">
        <h2
          class="py-3"
          :title="userdata?.name ? userdata?.name : 'unavailable user name'"
        >
          <div>Name</div>
          :&emsp;
          <v-progress-linear
      ...
      <div class="myProfileDetails d-flex justify-space-between align-center">
        <h2 class="py-3" title="user role">
          ...
          <span v-else>
            {{
              userdata?.roles[0] === "user" ? "Individual" : userdata?.roles[0]
            }}
          </span>
        </h2>
      </div>
      ...
      <div class="myProfileDetails d-flex justify-space-between align-center">
        <h2
          class="py-3"
          :title="userdata?.email ? userdata?.email : 'unavailable user email'"
        >
          <div>Email</div>
          :&emsp;
          <v-progress-linear
          ...
          <span v-else>
            {{ userdata?.email ? userdata?.email : "Not Found" }}
          </span>
          <span v-if="userdata.email_verified" class="pl-5" title="verified"
            ><v-icon
              size="20"
            ...
            ></v-icon
          ></span>
          <span v-else class="pl-5" title="not verified"
            ><v-icon
              size="20"
              color="red-darken-2"
      ...
      <div class="myProfileDetails d-flex justify-space-between align-center">
        <h2
          class="py-3"
          :title="
            userdata?.mobile ? userdata?.mobile : 'unavailable user mobile'
          "
        >
          <div>Contact</div>
          :&emsp;
          ...
          <span v-else>
            {{ userdata?.mobile ? userdata?.mobile : "Not Found" }}
          </span>
          <span v-if="userdata.mobile_verified" class="pl-5" title="verified"
            ><v-icon
              size="20"
              color="green-darken-2"
              icon="mdi-check-decagram"
      ...
      <div class="myProfileDetails d-flex justify-space-between align-center">
        <h2
          class="py-3"
          :title="
            userdata?.address ? userdata?.address : 'unavailable user address'
          "
        >
          <div>Address</div>
          :&emsp;
          ...
          <span v-else>
            {{ userdata?.address ? userdata?.address : "NotFound" }}
          </span>
        </h2>
      </div>
      ...
      <div class="myProfileDetails d-flex justify-space-between align-center">
        <h2
          class="py-3"
          :title="userdata?.city ? userdata?.city : 'unavailable user city'"
        >
          <div>City</div>
          :&emsp;
          <v-progress-linear
          ...
          <span v-else>
            {{ userdata?.city ? userdata?.city : "Not Found" }}
          </span>
        </h2>
      </div>
      ...
      <div class="myProfileDetails d-flex justify-space-between align-center">
        <h2
          class="py-3"
          :title="userdata?.state ? userdata?.state : 'unavailable user state'"
        >
          <div>State</div>
          :&emsp;
          <v-progress-linear
          ...
          <span v-else>
            {{ userdata?.state ? userdata?.state : "NotFound" }}
          </span>
        </h2>
      </div>
      ...
      <div class="myProfileDetails d-flex justify-space-between align-center">
        <h2
          class="py-3"
          :title="
            userdata?.country ? userdata?.country : 'unavailable user country'
          "
        >
          <div>Country</div>
          :&emsp;
          ...
          <span v-else>
            {{ userdata?.country ? userdata?.country : "NotFound" }}
          </span>
        </h2>
      </div>
...
async function getUser() {
  ...
  if (res?.status === 200) {
    ...
    profileStatus.value = Math.ceil(
      (count.value / Object.entries(userdata.value).length) * 100
    );
