  ...
  <v-container class="pa-0">
    <v-row no-gutters>
      <v-col cols="12" class="pa-0">
        <div
          class="pa-6 text-center text-h4 font-weight-medium text-decoration-underline"
        >
          Properties
        </div>
      </v-col>
        ...
        >
          <v-card class="mx-auto my-3" width="280">
            ...
            <v-card-actions class="d-flex flex-column">
              <v-btn
                class="ma-2"
                @click="displayDisplay(item?.propertyId)"
                variant="outlined"
                color="orange"
                >Display Details</v-btn
              >
              <div class="ma-2s">
                <v-btn
                  @click="updateProperty(item?.propertyId)"
                  variant="outlined"
                  color="orange"
                >
                  Update
    ...
    <v-row
      v-if="properties"
      no-gutters
      class="px-sm-14 py-5 d-flex justify-center align-center"
    >
      <v-col cols="5">
    ...
    <v-row
      v-if="!properties"
      no-gutters
      class="px-sm-14 d-flex justify-center align-center"
      style="height: 100%"
    >
