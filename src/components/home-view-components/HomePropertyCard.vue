  ...
  >
    <v-hover v-if="!isMobileDevice" v-slot="{ isHovering, props }">
      ...
      >
        ...
        <div class="verifiedTagContainer">
          ...
          <v-card-title
            title="verified by Checked Spot"
    ...
    <v-row no-gutters class="mt-1">
      <v-col cols="12" class="pa-0 mt-2">
        <v-card-text class="propType pa-0 font-weight-medium" :title="property?.type">
          Property type:
        ...
        <v-card-text
          v-if="address"
          class="address pa-0 font-weight-medium"
          :title="address"
        >
          Location:
        ...
        <v-card-text
          v-else
          class="unavailable pa-0 text-body-2 text-grey-darken-1"
        >
        ...
        <!-- agent Name -->
        <v-card-text
          v-if="property?.agent?.name"
          class="name pa-0 font-weight-medium"
          :title="property?.agent?.name"
        >
          Name:
          <span class="font-weight-regular">
            {{ property?.agent?.name }}
        ...
        <!-- Agent Mobile -->
        <v-card-text
          v-if="property?.agent?.mobile"
          class="mobile pa-0 font-weight-medium"
          :title="property?.agent?.mobile"
        >
          Mobile:
          <span class="font-weight-regular">
...
onMounted(() => {
    if(property.value?.address) {
        address.value = property.value?.address;
    } else {
        ...
        const country = props?.property?.locality ? `${props?.property?.country}`: '';
