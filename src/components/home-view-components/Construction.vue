<template>
    <v-container fluid class="pa-0">
        <v-expand-transition>
                    <v-card
                        style="position: fixed; top: 63px; z-index: 1"
        ...
        <v-row no-gutters class="bgConstruction d-flex justify-space-between py-10 py-md-0">
            ...
            <v-col cols="12" md="5" class="pr-md-16 pl-md-10 py-10 d-flex justify-center justify-md-end">
                ...
                <form class="bg-white px-8 pt-5 pb-8 rounded-lg" style="max-width:350px">
                    ...
                    <v-text-field v-model="enquiryMessage.value.value" :error-messages="enquiryMessage.errorMessage.value" counter="40" density="compact" 
                    label="Enquiry Message" variant="outlined"></v-text-field>
                    ...
                    <p class="caption"><span class="text-red">* </span>By submitting this form, I confirm that I have read and agreed to accept CheckedSpot's <RouterLink  to="/privacypolicy">privacy policy</RouterLink></p>
