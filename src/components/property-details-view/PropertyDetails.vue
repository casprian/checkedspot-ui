        ...
        <v-col cols="12">
            <v-card class="rounded-0 px-2 pb-4 pt-2" elevation="2">
                <v-row no-gutters>
                    ...
                    <v-col v-if="props.details?.propertyAddedDate" cols="12" sm="6"
                        class="d-flex justify-sm-end justify-end align-center">
                        <v-card-item class="titleCont mb-4">
                            <v-card-title
                                class="px-3 text-body-2 text- font-weight-regular bg-blue-grey-lighten-1 rounded-pill"
