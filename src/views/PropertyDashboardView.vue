          ...
          <v-col cols="12">
            ...
            >
              <v-window-item value="Property" class="pa-10">
                ...
                <div>
                  <edit-plot-details
                    v-if="property.details.type === 'plot'"
                    :details="property.details"
                  />
                  <edit-farmland-details
                    v-if="property.details.type === 'farmland'"
                    :details="property.details"
                  />
                  <edit-flat-details
                    v-if="property.details.type === 'flat'"
                    :details="property.details"
                  />
                </div>
                  ...
                  <v-container fluid class="pa-0">
                    <v-row no-gutters class="mb-3">
                      <v-col
                        cols="12"
                        class="pa-0"
                        style="border-bottom: solid 2px grey"
                      >
                        <div
                          class="text-h5 text-grey-darken-2 font-weight-medium"
                        >
                          Edit Document
                        </div>
                      </v-col>
                    ...
                    <v-row no-gutters>
                      <div
                        ...
                        class="text-h4 text-center pa-8 pt-6"
                      >
                          ...
                          <v-card color="grey-lighten-5">
                            <v-row no-gutters class="pa-10 pt-7">
                              ...
                              <v-row no-gutters>
                                ...
                                <v-col
                                  v-if="docUploadFailed"
                                  cols="12"
                                  class="mt-3 text-h6 text-center text-red"
                                  >Document Upload Failed!</v-col
                                >
                                <v-col
                                  v-if="documentAddFailed"
                                  cols="12"
                                  class="mt-3 text-h6 text-center text-red"
...
const EditPlotDetails = defineAsyncComponent(
  () => import("@/components/property-dashboard/EditPlotDetails.vue")
);
const EditFarmlandDetails = defineAsyncComponent(
  () => import("@/components/property-dashboard/EditFarmlandDetails.vue")
);
const EditFlatDetails = defineAsyncComponent(
  () => import("@/components/property-dashboard/EditFlatDetails.vue")
);
const EditPropertyImages = defineAsyncComponent(
  () => import("@/components/property-dashboard/EditPropertyImages.vue")
);
const EditPropertyVideos = defineAsyncComponent(
  () => import("@/components/property-dashboard/EditPropertyVideos.vue")
);
const EditPropertyDocuments = defineAsyncComponent(
  () => import("@/components/property-dashboard/EditPropertyDocuments.vue")
);
const EditPropertyAgents = defineAsyncComponent(
  () => import("@/components/property-dashboard/EditPropertyAgents.vue")
);
...
function enableOtherDocUpload(type: string) {
  type === "other"
    ? (otherDocument.value = true)
    : (otherDocument.value = false);
}
