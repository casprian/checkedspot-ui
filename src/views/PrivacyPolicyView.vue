<template>
    <v-container fluid class="pa-0">
        ...
        <v-row no-gutters class="pa-16">
            ...
            <h2 class="text-h5 text-sm-h4 font-weight-medium">Collecting and Using Your Personal Data</h2>

            <v-col cols="12">
                <br />
                <h3 class="text-h6 text-sm-h5 font-weight-medium">Types of Data Collected</h3>
                <br />
                <h4 class="text-h5 text-sm-h6 font-weight-medium">Personal Data</h4>
                <br />
                ...
                <h4 class="text-h5 text-sm-h6 font-weight-medium">Usage Data</h4>
                <br />
                ...
                <h4 class="text-h5 text-sm-h6 font-weight-medium">Tracking Technologies and Cookies</h4>
                <br />
                ...
                <div class="ttc">
                    <ul>
                        ...
                        <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or
                            ...
                            change the settings for disabling, or deleting local shared objects?” available at <br /><a
            ...
            <v-col cols="12">
                <h3 class="text-h6 text-sm-h5 font-weight-medium">Use of Your Personal Data</h3>
                <br />
            ...
            <v-col cols="12">
                <h3 class="text-h6 text-sm-h5 font-weight-medium">Retention of Your Personal Data</h3>
                <br />
            ...
            <v-col cols="12">
                <h3 class="text-h6 text-sm-h5 font-weight-medium">Disclosure of Your Personal Data</h3>
                <br />
            ...
            <v-col cols="12">
                <h3 class="text-h6 text-sm-h5 font-weight-medium">Security of Your Personal Data</h3>
                <br />
            ...
            <v-col cols="12">
                <h3 class="text-h6 text-sm-h5 font-weight-medium">Children’s Privacy</h3>
                <br />
            ...
            <v-col cols="12">
                <h3 class="text-h6 text-sm-h5 font-weight-medium">Links to Other Websites</h3>
                <br />
            ...
            <v-col cols="12">
                <h3 class="text-h6 text-sm-h5 font-weight-medium">Changes to this Privacy Policy</h3>
                <br />
            ...
            <v-col cols="12">
                <h3 class="text-h6 text-sm-h5 font-weight-medium">Contact Us</h3>
                <br />
