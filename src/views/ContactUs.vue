    ...
    <v-container>
      <v-row no-gutters class="d-flex justify-space-between">
            ...
            <v-col cols="auto" class="ma-2 d-flex justify-center">
              <v-card class="mx-auto" max-width="370">
                ...
                <v-img
                  cover
                  height="250"
                  src="https://checkedspot.blob.core.windows.net/assets/bangalore.jpg"
                ></v-img>
                ...
                <v-card-text>
                  ...
                  <div class="my-4 text-subtitle-1">
                    1st floor - Next To Fame Diagnostics - RK Hegde Nagar
                    Bangalore
                  </div>
        ...
        <v-col cols="12" sm="6" md="4" class="my-12" style="position: relative">
          <v-card
            class="ma-2 px-5 pt-3 pb-10 elevation-7 rounded-0"
            width="100%"
          >
