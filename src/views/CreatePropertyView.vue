    ...
    <v-container>
        <form>
            <v-row no-gutters>
                ...
                <v-col cols="12" sm="6" class="py-1 px-3">
                    <v-select v-model="type.value.value" :error-messages="type.errorMessage.value" :items="types" label="property type(plot, flat, etc."
                        variant="outlined" clearable hint="Choose from the list of property types"></v-select>
                </v-col>

                <v-row no-gutters v-if="type.value.value === 'plot'" class="py-3 mt-7 type">
                    ...
                    <v-col cols="12" sm="6" class="py-1 px-3">
                        <v-switch v-model="bodyData.isFreeHold" true-value="true" false-value="false" label="Is Free Hold" color="pink-accent-3" hide-details></v-switch>
                    </v-col>
                ...
                <v-row no-gutters v-if="type.value.value === 'flat'" class="py-3 mt-7 type">
                    <v-col cols="12" class="pt-2 pb-7 px-4">
                    ...
                    <v-col cols="12" sm="6" class="py-1 px-3">
                        <v-select v-model="bodyData.furnishedStatus" :items="furnishedStatus"
                            label="Furnished status" variant="outlined" clearable
                ...
                <v-row no-gutters class="py-3 mt-7 type">
                    ...
                    <v-col cols="12" class="py-1 px-3">
                        <v-file-input v-model="imgfile.value.value" :error-messages="imgfile.errorMessage.value"  label="File input" variant="filled"
                    ...
                    <v-col cols="12" class="py-1 px-3">
                        <v-file-input v-model:modal-value="bodyData.planimgfile" label="File input" variant="filled"
                    ...
                    <v-col cols="12" class="py-1 px-3">
                        <v-file-input v-model:modal-value="bodyData.vidfile" label="File input" variant="filled"
...
const planimgfile = useField('planimgfile');
const vidfile = useField('vidfile');
