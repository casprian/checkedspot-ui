  ...
  <v-container class="mt-6">
    <v-row no-gutters>
      <v-col cols="12" md="6" class="elevation-2 pa-10 mb-10 mb-md-0">
        <v-row no-gutters>
          ...
          <v-col cols="12" class="pt-3 myProfileDetails">
            ...
            >
              <div>Name</div>
              :&emsp;{{ userdata?.name ? userdata?.name : "Not Found" }}
            </h2>
            <h2
              class="py-3"
              :title="
                userdata?.email ? userdata?.email : 'unavailable user email'
              "
            >
              <div>Email</div>
              :&emsp;{{ userdata?.email ? userdata?.email : "Not Found" }}
            </h2>
            <h2
              class="py-3"
              :title="
            ...
            >
              <div>Contact</div>
              :&emsp;{{ userdata?.mobile ? userdata?.mobile : "Not Found" }}
            </h2>
            <h2
              class="py-3"
              :title="
                userdata?.address
                  ? userdata?.address
                  : 'unavailable user address'
              "
            >
              <div>Adress</div>
              :&emsp;{{ userdata?.address ? userdata?.address : "Not Found" }}
            </h2>
            <h2
              class="py-3"
            ...
            >
              <div>City</div>
              :&emsp;{{ userdata?.city ? userdata?.city : "Not Found" }}
            </h2>
            <h2
              class="py-3"
              :title="
                userdata?.state ? userdata?.state : 'unavailable user state'
              "
            >
              <div>State</div>
              :&emsp;{{ userdata?.state ? userdata?.state : "Not Found" }}
            </h2>
            <h2
              class="py-3"
              :title="
                userdata?.country
                  ? userdata?.country
                  : 'unavailable user country'
              "
            >
              <div>Country</div>
              :&emsp;{{ userdata?.country ? userdata?.country : "Not Found" }}
            </h2>
          </v-col>
          <v-col class="mt-4">
            <v-btn
      ...
      <v-col
        cols="12"
        md="6"
        class="elevation-2 pa-10 d-none d-md-block"
      ...
      >
        <v-form>
          <v-row no-gutters>
            <v-col
              cols="12"
              class="d-flex justify-space-between align-center mb-10"
            >
              <h1>Edit Profile</h1>
              <v-avatar
                color="grey-darken-3"
