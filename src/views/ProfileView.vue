        ...
        <v-row no-gutters>
          ...
          <v-col cols="12" class="pt-3 myProfileDetails">
            ...
            <h2 class="py-3" :title="userdata?.name ? userdata?.name : 'unavailable user name'">
              <div>Name</div>:&emsp;<v-progress-linear v-if="loading" indeterminate location="left" color="pink-accent-2"></v-progress-linear><span v-else>{{ userdata?.name ? userdata?.name : "Not Found" }}</span>
            </h2>

            <h2 class="py-3" :title="userdata?.email ? userdata?.email : 'unavailable user email'">
              <div>Email</div>&emsp;<v-progress-linear v-if="loading" indeterminate location="left" color="pink-accent-2"></v-progress-linear><span v-else>{{ userdata?.email ? userdata?.email : "Not Found" }}</span>
            </h2>

            <h2 class="py-3" :title="userdata?.mobile ? userdata?.mobile : 'unavailable user mobile'">
              <div>Contact</div>:&emsp;<v-progress-linear v-if="loading" indeterminate location="left" color="pink-accent-2"></v-progress-linear><span v-else>{{ userdata?.mobile ? userdata?.mobile : "Not Found" }}</span>
            </h2>

            <h2 class="py-3" :title="userdata?.address ? userdata?.address : 'unavailable user address'">
              <div>Adress</div>:&emsp;<v-progress-linear v-if="loading" indeterminate location="left" color="pink-accent-2"></v-progress-linear><span v-else>{{ userdata?.address ? userdata?.address : "Not Found" }}</span>
            </h2>

            <h2 class="py-3" :title="userdata?.city ? userdata?.city : 'unavailable user city'">
              <div>City</div>:&emsp;<v-progress-linear v-if="loading" indeterminate location="left" color="pink-accent-2"></v-progress-linear><span v-else>{{ userdata?.city ? userdata?.city : "Not Found" }}</span>
            </h2>

            <h2 class="py-3" :title="userdata?.state ? userdata?.state : 'unavailable user state'">
              <div>State</div>:&emsp;<v-progress-linear v-if="loading" indeterminate location="left" color="pink-accent-2"></v-progress-linear><span v-else>{{ userdata?.state ? userdata?.state : "Not Found"}}</span>
            </h2>

            <h2 class="py-3" :title="userdata?.country ? userdata?.country : 'unavailable user country'">
              <div>Country</div>:&emsp;<v-progress-linear v-if="loading" indeterminate location="left" color="pink-accent-2"></v-progress-linear><span v-else>{{ userdata?.country ? userdata?.country : "Not Found" }}</span>
            </h2>
        ...
        <v-form>
          <v-row no-gutters>
            ...
            <v-col cols="12">
              ...
              <v-text-field placeholder="Enter your Name" v-model="userdata.name" variant="outlined">
                <template v-slot:loader>
                  <v-progress-linear v-if="loading" indeterminate color="pink-accent-2"></v-progress-linear>
                </template>
              </v-text-field>
            </v-col>
            ...
            <v-col cols="12" class="pt-1">
              ...
              <v-text-field placeholder="Enter your Number" v-model="userdata.mobile" variant="outlined">
                <template v-slot:loader>
                  <v-progress-linear v-if="loading" indeterminate color="pink-accent-2"></v-progress-linear>
                </template>
              </v-text-field>
            ...
            <v-col cols="12" class="pt-1">
              ...
              <v-text-field placeholder="Enter your Adress" v-model="userdata.address" variant="outlined">
                <template v-slot:loader>
                  <v-progress-linear v-if="loading" indeterminate color="pink-accent-2"></v-progress-linear>
                </template>
              </v-text-field>
            ...
            <v-col cols="12" class="py-1">
              ...
              <v-select placeholder="Select" :items="cityitems" v-model="userdata.city" variant="outlined">
                <template v-slot:loader>
                  <v-progress-linear v-if="loading" indeterminate color="pink-accent-2"></v-progress-linear>
                </template>
              </v-select>
            ...
            <v-col cols="12" class="pt-1">
              ...
              <v-select placeholder="Select" :items="Stateitems" v-model="userdata.state" variant="outlined">
                <template v-slot:loader>
                  <v-progress-linear v-if="loading" indeterminate color="pink-accent-2"></v-progress-linear>
                </template>
              </v-select>
            ...
            <v-col cols="12" class="py-1">
              ...
              <v-select placeholder="Select" :items="countryitems" v-model="userdata.country" variant="outlined">
                <template v-slot:loader>
                  <v-progress-linear v-if="loading" indeterminate color="pink-accent-2"></v-progress-linear>
                </template>
              </v-select>
