<template>
    <v-row no-gutters class="mb-16">
        ...
        <v-col cols="12" class="mb-10 mt-12 mb-md-0">
            <v-row no-gutters>
                <v-col cols="12" md="6">
                    <v-img src="https://checkedspot.blob.core.windows.net/assets/digitalAnalytics.jpg" max-height="400" cover></v-img>
                </v-col>
        ...
        <v-col cols="12" class="mb-10 mt-12 mb-md-0">
            <v-row no-gutters class="d-flex flex-column-reverse flex-md-row">
                ...
                <v-col cols="12" md="6">
                    <v-img src="https://checkedspot.blob.core.windows.net/assets/unlockDevelopment.jpeg" height="400" cover></v-img>
                </v-col>
            </v-row>
        </v-col>
        ...
        <v-col cols="12">
            <v-row no-gutters>
                <v-col cols="12" md="6">
                    <v-img src="https://checkedspot.blob.core.windows.net/assets/driveValues.jpg" max-height="400" cover></v-img>
                </v-col>
